        ...
        <div className='my-64'>
            ...
            <div className='w-[75%] mx-auto relative lg:w-[90%] md:w-full'>
                ...
                <ul className='w-full flex flex-col items-start justify-between ml-4 xs:ml-2'>
                    <Details type="Software Engineering Certificate" time="2022-2023" place="App Academy" info="Completed coursework in advanced topics such as Reinforcement Learning, Computer Vision, and Machine Learning Engineering." />
                    ...
                    <Details type="Bachelor's in Urban Studies" time="2003-2007" place="University of New Orleans" info="Relevant courses included Data Structures and Algorithms, Computer Systems Engineering, and Artificial Intelligence." />
                </ul>
            </div>
        </div>
    )
