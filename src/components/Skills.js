...
import { MongoDbIcon, PostgresqlIcon, ReactIcon, NodeJSIcon, JavascriptIcon, HtmlIcon, PythonIcon, CSSIcon, APIIcon, DjangoIcon, DockerIcon, AWSIcon, ReadMeIcon, TailWindIcon, CodeSandboxIcon } from "./Icons";
